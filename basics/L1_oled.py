...
def getVoltage():
    ...
    return voltage # Be sure to return your variable name for your getVoltage()
...
def displayText():
    ...
    #################################################
    draw.text((30, 0), "Gipsy Danger", font=font, fill=255)
    ...
    #################################################
    volts = str(getVoltage())
    draw.text((0, 40), "Robot Voltage: " + volts + "V", font=font, fill=255)
